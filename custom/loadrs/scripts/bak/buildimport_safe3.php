...
function load_lookups () {
    ...
    //more fields
    $RS_FIELDID_LKP['IS_PRIMARY'] = 88;                                
    $RS_FIELDID_LKP['LONG_DESCRIPTION'] = 87;                                
    $RS_FIELDID_LKP['SHORT_DESCRIPTION'] = 86;                                
    $RS_FIELDID_LKP['LONG_NAME'] = 85;                                
    $RS_FIELDID_LKP['SHORT_NAME'] = 76;                                
    $RS_FIELDID_LKP['THUMBNAIL_URL'] = 89;                                
    $RS_FIELDID_LKP['BACKGROUND_URL'] = 90;                                
    $RS_FIELDID_LKP['CC_URL'] = 91;                                
    $RS_FIELDID_LKP['DURATION'] = 92;                                
    $RS_FIELDID_LKP['LANGUAGE'] = 93;                                
    $RS_FIELDID_LKP['ASPECT_RATIO'] = 94;                                
    $RS_FIELDID_LKP['CAN_EMBED'] = 95;                                
    $RS_FIELDID_LKP['CAN_DOWNLOAD'] = 96;                                
    $RS_FIELDID_LKP['VIEW_COUNT'] = 97;                                
    $RS_FIELDID_LKP['IS_PUBLISHED'] = 98;                                
    $RS_FIELDID_LKP['SHARE_COUNT'] = 99;                                
    $RS_FIELDID_LKP['ACCESS_TXT'] = 100;                                
    $RS_FIELDID_LKP['RIGHTS_TXT'] = 101;                                
    $RS_FIELDID_LKP['CREDITS_TXT'] = 102;                                
    $RS_FIELDID_LKP['DETAIL_URL'] = 103;                                
    $RS_FIELDID_LKP['MEDIA_SERVER_ID'] = 104;                                
    $RS_FIELDID_LKP['IS_STREAMABLE'] = 105;                                
    //system
...
foreach ( array_keys($mediaobject) as $key) {
      ...
      if ( $derivative_found ) {
        ...
        $resfile="{$IMPORTDATA['FILE_NAME']}.{$IMPORTDATA['FILE_EXTENSION']}";
