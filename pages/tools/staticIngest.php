...
include (dirname(__FILE__) . "/../../LOC/classes/FieldMap.php");
include(dirname(__FILE__) . "/../../LOC/classes/MediaApiClient.php");
include(dirname(__FILE__) . "/../../LOC/classes/JsonParser.php");
...
function updateDerivativeMetadata($r, $altid, $metadataFile) {
										...
										echo " - Extracted metadata from path: $value\n";
                                                                        ...
                                                                        if(file_exists($metadatafile)) {
                                                                            ...
                                                                            updateMediaMetadata($r, $metadatafile);
                                                                             //now you can update the rest of the metadata, call my update metada function
						...
						while (($altfile = readdir($adh)) !== false)
							...
							if (($filetype=="file") && (substr($file,0,1)!=".") && (strtolower($file)!="thumbs.db"))
								...
								rename ($altpath . "/" . $altfile,$path); # Move alternative file
                                                                ...
                                                                echo "derivative Metadata File: $metadatafile";
                                                                if(file_exists($derMetadataFile)) {
                                                                    updateDerivativeMetadata($r, $aref, $derMetadataFile);
                                                                }
                                                                //here is where you can do metadata update for derivatives
								}
							}	
						}
